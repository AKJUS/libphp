# Lambda Node.js 24 Shared Libraries

This document lists all shared libraries (`*.so*`) available in the Lambda Node.js 24 runtime environment.

## Overview

- **Runtime**: Node.js 24
- **Endpoint**: https://php-node24.vercel.app/
- **Last Updated**: 2026-01-13
- **Total Libraries**: ~390+ (varies by path)
...
1. Execute the shell script via Node.js 24 endpoint:
   ```bash
