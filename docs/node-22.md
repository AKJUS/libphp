# Lambda Node.js 22 Shared Libraries

This document lists all shared libraries (`*.so*`) available in the Lambda Node.js 22 runtime environment.

## Overview

- **Runtime**: Node.js 22
- **Endpoint**: https://php-node22.vercel.app/
...
1. Execute the shell script via Node.js 22 endpoint:
   ```bash
